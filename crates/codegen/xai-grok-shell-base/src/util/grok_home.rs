...
pub use xai_grok_config::{
    ...
    ensure_sessions_cwd_dir, ensure_sessions_cwd_dir_in, foreign_sessions_root, grok_application,
    grok_home, sessions_cwd_dir, sessions_cwd_dir_in, set_dir_owner_only,
};
